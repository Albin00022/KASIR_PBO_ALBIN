...
public class AdminMenu extends JFrame {
    ...
    private final Color ACCENT_RED = new Color(239, 68, 68);           // #EF4444
    ...
    private void initUI() {
        ...
        panelStats.add(createStatCard("📦 Total Produk", "128", PRIMARY_PURPLE, ACCENT_LAVENDER));
        panelStats.add(createStatCard("🧾 Transaksi", "342", ACCENT_PINK, PRIMARY_LIGHT));
        panelStats.add(createStatCard("👥 Pengguna", "89", ACCENT_LAVENDER, PRIMARY_LIGHT));
        panelStats.add(createStatCard("💰 Pendapatan", "Rp 24,5Jt", ACCENT_PINK, PRIMARY_LIGHT));
        add(panelStats);
        ...
        txtCari.setBackground(new Color(250, 248, 255));
        ...
        btnTambah = createActionButton("➕ Tambah", ACCENT_PINK);
        btnEdit = createActionButton("✏️ Edit", PRIMARY_PURPLE);
        ...
        btnSimpan.setBackground(PRIMARY_PURPLE);
        ...
        tableProduk.getTableHeader().setBackground(PRIMARY_PURPLE);
        ...
        tableProduk.getColumnModel().getColumn(4).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                btnEdit.setBackground(PRIMARY_PURPLE);
    ...
    private JPanel createStatCard(String title, String value, Color bg, Color accent) {
        ...
        card.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { card.setBackground(new Color(250,248,255)); }
