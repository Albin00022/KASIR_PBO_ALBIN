...
public class PelangganMenu extends JFrame {
    ...
    private final Color PRIMARY_PURPLE = new Color(139, 92, 246);      // #8B5CF6
    private final Color PRIMARY_DARK = new Color(109, 40, 217);        // #6D28D9
    private final Color PRIMARY_LIGHT = new Color(221, 214, 254);      // #DDD6FE
    private final Color BG_GRADIENT_TOP = new Color(250, 248, 255);    // #FAF8FF
    private final Color BG_GRADIENT_BOTTOM = new Color(245, 243, 255); // #F5F3FF
    ...
    private final Color BORDER_SOFT = new Color(226, 220, 240);        // #E2DCF0
    private final Color BORDER_FOCUS = new Color(139, 92, 246);        // #8B5CF6
    private final Color ACCENT_PINK = new Color(236, 72, 153);         // #EC4899
    private final Color ACCENT_LAVENDER = new Color(167, 139, 250);    // #A78BFA
    ...
    private void initUI() {
        ...
        btnLogout.setBackground(ACCENT_PINK);
        ...
        btnLogout.setBorder(new RoundedBorder(10, ACCENT_PINK));
        
        btnLogout.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnLogout.setBackground(new Color(190, 24, 93));
                btnLogout.setBorder(new RoundedBorder(10, new Color(190, 24, 93)));
            }
        ...
        txtTotal.setForeground(PRIMARY_PURPLE);
        txtTotal.setBackground(PRIMARY_LIGHT);
        txtTotal.setHorizontalAlignment(JTextField.RIGHT);
        txtTotal.setEditable(false);
        txtTotal.setBorder(new RoundedBorder(10, PRIMARY_PURPLE));
        ...
        btnBeli.setBackground(PRIMARY_PURPLE);
        ...
        btnBeli.setBorder(new RoundedBorder(12, PRIMARY_PURPLE));
        
        btnBeli.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                btnBeli.setBackground(PRIMARY_DARK);
                btnBeli.setBorder(new RoundedBorder(12, PRIMARY_DARK));
            }
            public void mouseExited(MouseEvent e) {
                btnBeli.setBackground(PRIMARY_PURPLE);
                btnBeli.setBorder(new RoundedBorder(12, PRIMARY_PURPLE));
            ...
            public void mousePressed(MouseEvent e) {
                btnBeli.setBackground(new Color(88, 28, 190));
            }
        ...
        tableTransaksi.getTableHeader().setBackground(PRIMARY_PURPLE);
    ...
    // ✅ Helper: Create modern card panel (Ungu Theme)
    ...
    // ✅ Helper: Modern ComboBox (Ungu Theme)
    private JComboBox<String> createModernComboBox() {
        ...
        cb.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList<?> list, Object value, 
                ...
                if (isSelected) {
                    label.setBackground(PRIMARY_PURPLE);
